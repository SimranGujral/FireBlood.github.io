...
This point is important because it means we can move to a Rust Based solution without a performance regression. It means that we can usew the rust crypto primitives in Ring without slowing down the process of verification
...
As we see, only 1% of the websites depend on TLS 1.1. 5 % of the websites depend on TLS 1.0. Support for TLS 1.0 is a cause for concern for us. 
