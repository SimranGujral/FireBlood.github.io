...
#### Hyper-Rustls
Hyper is a networking library. As Hyper-Rustls it uses Rustls to make its connections secure. Hyper-Rustls works as a connection between Hyper- a networking library and Rustls - a TLS implementations to make network connections secure.
