...
version of the TLS stack that you use work correctly. Also, since you want to move to a leaner version, you want to try to make sure that  the stack supports most of the features that the web depends on. 
